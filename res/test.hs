...
happyExpList = Happy_Data_Array.listArray (0,51) ([18848,64,1024,57344,1,0,26624,53266,36,188,32768,294,0,0,0,0,256,18848,0,0,57856,39425,32772,7,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseCalc","Exp","Binop","let","in","int","var","'='","'+'","'-'","'*'","'/'","'('","')'","%eof"]
...
happyReduction_4 _
	...
	(HappyTerminal happy_var_1)
	 =  HappyAbsSyn4
		 (Parentheses happy_var_1 happy_var_2
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenSym happy_dollar_dollar -> cont 9;
	TokenEq -> cont 10;
	TokenPlus -> cont 11;
	TokenMinus -> cont 12;
	TokenTimes -> cont 13;
